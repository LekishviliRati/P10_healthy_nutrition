"""
Django settings for better_nutrition project.
...
ROOT_URLCONF = 'better_nutrition.urls'
...
WSGI_APPLICATION = 'better_nutrition.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    # os.path.join(BASE_DIR, 'static'), # Old
]
